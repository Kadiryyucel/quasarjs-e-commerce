<template>
  <div>
    <second-layout class="second">
      <div>
        <div class="text-h5 q-pt-md">Contact Informatin</div>

        <div class="row col-12 q-gutter-y-lg q-py-sm">
          <q-input outlined v-model="text" :dense="dense" class="col-12"
                   label="Email Address">
...
export default defineComponent({
  ...
  components: { ShippingAdress, ShippingMethod, SecondLayout },
...
.second {
  ...
  .shipping-method {
    .q-card {
      ...
      background-color: rgb(239, 246, 254,30%);
    }
  }
  ...
  .q-badge {
    background: #7782F1 !important;
  }

  .order-btn {
    border-radius: 16px;
    padding: 12px 12px;
    background-color: #050824 !important;
  }
  ...
  .right-payment-panel{
    ...
    +div{
      ...
      background-color: rgb(239, 246, 254,20%);
    }
  }
  .add{
    padding: 4px 30px;
